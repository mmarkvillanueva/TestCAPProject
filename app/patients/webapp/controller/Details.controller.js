...
function (Controller, JSONModel, Device, History) {
	"use strict";

	return Controller.extend("patients.controller.Details", {
		...
		onInit: function () {
			...
			var bIsPhone = Device.system.phone,
			    svgLogo = sap.ui.require.toUrl("patients/controller/sap-logo.svg"),
